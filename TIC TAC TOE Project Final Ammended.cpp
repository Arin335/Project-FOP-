...
bool Win() {
	...
	if(Board[n][n]== 'X' && Board[n+1][n+1]== 'X' && Board[n+2][n+2]== 'X')					//Leading Diagonal
	return true;
	if(Board[n][n]== 'O' && Board[n+1][n+1]== 'O' && Board[n+2][n+2]== 'O')
	return true;
	if(Board[n][m]== 'X' && Board[n+1][m-1]== 'X' && Board[n+2][m-2]== 'X')					//Other Diagonal 
	return true;
...
int main() {
	cout<<"TIC TAC TOE"<<endl<<"___________"<<endl<<endl;
